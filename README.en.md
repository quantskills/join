...
<p align="center">
  <a href="https://github.com/quantskills/join/issues/new?template=join-request.yml"><img alt="apply" src="https://img.shields.io/badge/apply-Join%20Request-brightgreen"></a>
  <a href="COMMUNITY_RULES.md"><img alt="rules" src="https://img.shields.io/badge/community-COMMUNITY__RULES-blue"></a>
  <img alt="principle" src="https://img.shields.io/badge/principle-low%20barrier%20%C2%B7%20high%20standard-orange">
  <img alt="form" src="https://img.shields.io/badge/method-public%20issue%20form-9cf">
</p>
...
```mermaid
flowchart LR
    A["📜 Read the rules<br/>COMMUNITY_RULES.md"] --> B["📝 Open a public application<br/>Join Request issue form"]
    B --> C["🔍 Maintainer review<br/>public background · interests · contribution direction"]
    C --> D{"Approved?"}
    D -->|Yes| E["📧 Org admin invites you to the<br/>appropriate team or project"]
    D -->|Not yet| F["💬 Follow up in the issue"]
